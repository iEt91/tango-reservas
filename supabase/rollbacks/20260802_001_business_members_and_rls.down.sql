...
alter table if exists public.business_members no force row level security;
...
drop function if exists private.is_business_member(uuid);
drop function if exists private.current_business_role(uuid);
