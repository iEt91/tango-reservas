...
## Etapa v5.4.6-crm-lab

- `/local/crm-lab` refina la ficha derecha del cliente seleccionado con mejor jerarquia visual, mas aire interno y mejor distribucion vertical;
