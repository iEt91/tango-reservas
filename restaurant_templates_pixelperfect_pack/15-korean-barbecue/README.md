...
- `assets/icons/`: small symbols and badges (52)
- `assets/ui/`: buttons, fields and controls (6)
- `assets/dividers/`: horizontal separators and repeated rules (3)
- `assets/panels/`: larger reusable frames/panels (0)
- `assets/ornaments/`: decorative motifs and larger flourishes (1)
