...
- `assets/icons/`: small symbols and badges (50)
- `assets/ui/`: buttons, fields and controls (3)
- `assets/dividers/`: horizontal separators and repeated rules (7)
- `assets/panels/`: larger reusable frames/panels (1)
- `assets/ornaments/`: decorative motifs and larger flourishes (2)
