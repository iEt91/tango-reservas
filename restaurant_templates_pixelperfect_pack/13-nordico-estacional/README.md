...
- `assets/icons/`: small symbols and badges (32)
- `assets/ui/`: buttons, fields and controls (4)
- `assets/dividers/`: horizontal separators and repeated rules (5)
- `assets/panels/`: larger reusable frames/panels (0)
- `assets/ornaments/`: decorative motifs and larger flourishes (3)
