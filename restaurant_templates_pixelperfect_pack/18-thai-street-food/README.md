...
- `assets/icons/`: small symbols and badges (26)
- `assets/ui/`: buttons, fields and controls (0)
- `assets/dividers/`: horizontal separators and repeated rules (9)
- `assets/panels/`: larger reusable frames/panels (0)
- `assets/ornaments/`: decorative motifs and larger flourishes (0)
